...
public class SuppliersFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldContactTitle = new javax.swing.JTextField();
        ...
        jTextFieldHomePage = new javax.swing.JTextField();
        ...
        jPanel1.add(jTextFieldCompanyName, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldContactName, gridBagConstraints);

        jLabel4.setText("Nazwa kontaktu w firmie");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 6;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        jLabel6.setText("Tytuł kontaktu w firmie");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldContactTitle, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldCity, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldRegion, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldPostalCode, gridBagConstraints);
        ...
        jLabel14.setText("Strona domowa");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldCountry, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 13;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 7, 15);
        jPanel1.add(jTextFieldHomePage, gridBagConstraints);
    ...
    private javax.swing.JTextField jTextFieldContactTitle;
    private javax.swing.JTextField jTextFieldCountry;
    private javax.swing.JTextField jTextFieldFax;
    private javax.swing.JTextField jTextFieldHomePage;
    ...
    private void addSupplier() {
        ...
        supplier.setCompanyName(jTextFieldCompanyName.getText());
        supplier.setContactName(jTextFieldContactName.getText());
        supplier.setContactTitle(jTextFieldContactTitle.getText());
        supplier.setAddress(jTextFieldAddress.getText());
        supplier.setCity(jTextFieldCity.getText());
        supplier.setRegion(jTextFieldRegion.getText());
        supplier.setPostalCode(jTextFieldPostalCode.getText());
        supplier.setCountry(jTextFieldCountry.getText());
        supplier.setPhone(jTextFieldPhone.getText());
        supplier.setFax(jTextFieldFax.getText());
        supplier.setHomePage(jTextFieldHomePage.getText());
